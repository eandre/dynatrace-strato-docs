...
```bash
git remote add encore encore://dynatrace-strato-demo-duui
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/dynatrace-strato-demo-duui/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/dynatrace-strato-demo-duui/settings/integrations/github)
